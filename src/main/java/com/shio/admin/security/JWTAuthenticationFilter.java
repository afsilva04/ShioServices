...
import static com.shio.admin.security.SecurityUtils.EXPIRATION_TIME;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            com.shio.admin.domain.User creds = new ObjectMapper()
                    .readValue(req.getInputStream(), com.shio.admin.domain.User.class);
